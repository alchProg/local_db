                          ...
                          children: [
                            ...
                            isEdited
                              ? IconButton(
                                ...
                                alignment: Alignment.center,
                                onPressed: () {
                                  _profileUpdate(descFieldController.text, titleFieldController.text);
                                },
                              ...
                              : IconButton(
                                  ...
                                  icon: const Icon(Icons.edit_note_rounded,color: Colors.lightBlue,),),
                          ],
                        ),
                ),
                Padding(
                  ...
                  child: AnimatedContainer(
                    decoration: BoxDecoration(
                      ...
                      color: isEdited
                          ? ThemeData.dark().dialogBackgroundColor.withOpacity(0.7)
                          : null,
                    ),
